<header>
    ...
    <nav class="navbar navbar-expand-lg boo">
        ...
        <div class="collapse navbar-collapse menuholder d-flex justify-content-center text-align-center"
            id="navbarSupportedContent">
            <ul class="navbar-nav  menu">
                <li class=" nav-item  sidebysides"><a class="nav-link none" href="index.php">Home</a></li>
                <li class=" nav-item  sidebysides"><a class="nav-link none" href="menu.php"> Menu</a></li>
                <li class=" nav-item sidebysides"><a class="nav-link none" href="gallery.php">Gallery</a></li>
